...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([0, 1, 2, 3], [0, 0, 0, 1, 2, 0], [4, 4, 4], [2, 0, 1])
    expected2 = ([1, 1, 2, 3], [2, 3, 4, 1, 2, 5], [4, 4, 4], [2, 6, 1])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([0, 0, 0, 0], [777, 0, 0, 1, 6, 0], [4, 7, 4], [4, 0, 4])
    expected3 = ([1, 2, 3, 4], [777, 5, 6, 1, 6, 7], [4, 7, 4], [4, 8, 4])
    zero_changer(test3)
    print()
    print('Test 3:')
